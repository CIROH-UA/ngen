...
namespace realization {
    ...
    std::shared_ptr<Catchment_Formulation> construct_formulation(
        ...
        if (forcing_config.provider == "CsvPerFeature" || forcing_config.provider == ""){
            ...
            f = data_access::NetCDFPerFeatureDataProvider::get_shared_provider(forcing_config.path, forcing_config.simulation_start_t, forcing_config.simulation_end_t, utils::getStdOut(), forcing_config.enable_cache);
